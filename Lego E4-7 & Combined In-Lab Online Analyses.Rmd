...
Model with all factors combined
```{r}
sona.all<-glm(Choice.Num ~ PreTimeDiff+PreEffDiff+FunDiff, family="binomial", data=sona)
...
tab_model(sona.all, sona.all2, transform=NULL, show.stat = T, digits.p=2)
```
