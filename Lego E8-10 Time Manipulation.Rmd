...
ggplot(tab, aes(axis1 = Choice.Reason, axis2 = Coded.Reason, y = n)) +
  ...
  scale_fill_manual("Strategy\nPredisposition", values=c(wes_palettes$GrandBudapest2[c(1,3,4,2)],
...
#### Predisposition and Time Rating
...
ggplot(graph2, aes(x=Coded.Reason, y=dep.avg, colour=Space))+ 
  ...
  scale_x_discrete("Self-Reported Strategy Predisposition")+
...
#### Organization Rating, Time Diff & Predisposition predicting choice selection
...
#### Organization Rating Predisposition predicting choice selection
